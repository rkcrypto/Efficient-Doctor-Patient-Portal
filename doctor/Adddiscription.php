...
<form class="form-inline mr-auto" action="discriptionesult.php" method="post" class="form-group">
  <input class="form-control mr-sm-2"  name="search" type="text" placeholder="Mobile No" aria-label="Search">
